...
export const categories = [
  ...
  { key: 'css', label: 'CSS', icon: '🎨', count: 0 },
  { key: 'browser', label: '浏览器原理', icon: '🌐', count: 0 },
  { key: 'network', label: '计算机网络', icon: '🌍', count: 0 },
  { key: 'algorithms', label: '数据结构与算法', icon: '🧮', count: 0 },
  { key: 'computer-basics', label: '计算机基础', icon: '🖥️', count: 0 },
  { key: 'design-patterns', label: '设计模式', icon: '🏗️', count: 0 },
  { key: 'miniapp', label: '小程序开发', icon: '📱', count: 0 },
  { key: 'civil-service', label: '公务员面试', icon: '🏛️', count: 0 },
...
class LRUCache {
  ...
  // ==================== 数据结构与算法 ====================
  {
    ...
    difficulty: 'easy',
    type: 'single',
    question: '以下哪个数据结构的查找时间复杂度是 O(1)？',
    options: [
      { label: '数组（按值查找）', value: 'a' },
      { label: '链表', value: 'b' },
      { label: '哈希表', value: 'c' },
      { label: '二叉搜索树', value: 'd' },
    ],
    answer: 'c',
    explanation: {
      correct: '哈希表通过哈希函数直接定位存储位置，平均查找时间复杂度为 O(1)。',
      thinking: '数组按值查找是 O(n)，链表查找是 O(n)，二叉搜索树平均 O(log n)，只有哈希表通过 key → hash → index 的映射实现 O(1) 查找。',
      pitfalls: '哈希表最坏情况（大量冲突）可能退化到 O(n)，但平均是 O(1)。',
    },
  },
  {
    id: 212,
    ...
    answer: 'c',
    explanation: {
      correct: '归并排序是稳定排序，相同元素的相对顺序在排序后不会改变。',
      thinking: '稳定性是指相等元素的相对顺序是否保持。归并排序在合并时优先取左边元素，保证了稳定性。快排和堆排序都不稳定。',
      pitfalls: 'JavaScript 的 Array.sort() 在 V8 中使用 TimSort（归并+插入的混合），是稳定排序。',
    },
  },
  {
    id: 213,
    ...
    options: [
      { label: '数据必须存储在链表中', value: 'a' },
      { label: '数据必须有序', value: 'b' },
      { label: '数据必须是数字类型', value: 'c' },
      { label: '数据必须是唯一值', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '二分查找要求数组必须有序（通常升序），每次比较中间元素来缩小搜索范围。',
      thinking: '二分查找的核心是"排除一半"——通过比较中间值与目标值，每次排除一半的元素。这依赖于数组有序的前提。',
      pitfalls: '二分查找要求数组支持随机访问（O(1)），所以链表不适合二分查找。',
    },
  },
  {
    id: 214,
    ...
    difficulty: 'hard',
    type: 'single',
    question: '动态规划和贪心算法的核心区别是什么？',
    options: [
      { label: '动态规划更快', value: 'a' },
      { label: '贪心考虑全局最优，DP 考虑局部最优', value: 'b' },
      { label: 'DP 考虑所有子问题取全局最优，贪心每步选局部最优', value: 'c' },
      { label: '两者完全相同', value: 'd' },
    ],
    answer: 'c',
    explanation: {
      correct: '动态规划通过状态转移方程考虑所有子问题的组合，取全局最优；贪心每步选择局部最优解，不回退。',
      thinking: '能用贪心的问题一定能用 DP，反之不行。贪心更快但需要证明局部最优 = 全局最优。DP 更通用但时间复杂度通常更高。',
      pitfalls: '贪心不是"更快的 DP"，两者解决问题的思路完全不同。',
    },
  },
  {
    id: 215,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '虚拟 DOM 的 Diff 算法将树的对比复杂度从 O(n³) 降到 O(n)，主要依赖哪个策略？',
    options: [
      { label: '只比较同层节点，不跨层级移动', value: 'a' },
      { label: '只比较叶子节点', value: 'b' },
      { label: '使用二分查找优化', value: 'c' },
      { label: '使用哈希表缓存结果', value: 'd' },
    ],
    answer: 'a',
    explanation: {
      correct: 'Diff 算法的核心策略是只比较同一层级的节点，不进行跨层级的移动操作，从而将复杂度从 O(n³) 降到 O(n)。',
      thinking: '传统树的对比算法需要 O(n²) 次比较 × O(n) 次移动 = O(n³)。React/Vue 的 Diff 通过三个策略优化：1) 只比较同层；2) 同类型才深入；3) 用 key 标识节点。',
      pitfalls: '只比较同层意味着如果节点从一个父元素移动到另一个父元素，Diff 会删除旧节点创建新节点，而不是移动。',
    },
  },
  ...
  // ==================== 计算机基础 ====================
  {
    ...
    options: [
      { label: '进程比线程更快', value: 'a' },
      { label: '进程是资源分配单位，线程是 CPU 调度单位', value: 'b' },
      { label: '线程不能共享内存', value: 'c' },
      { label: '一个进程只能有一个线程', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '进程是操作系统资源分配的最小单位，线程是 CPU 调度的最小单位。一个进程可以包含多个线程。',
      thinking: '进程拥有独立的内存空间，线程共享进程的内存。进程间通信需要 IPC（管道、消息队列等），线程间可以直接通信。进程创建/销毁开销大，线程开销小。',
      pitfalls: 'JavaScript 是单线程的（主线程），但浏览器是多进程多线程的。Web Worker 是真正的多线程。',
    },
  },
  {
    id: 217,
    ...
    difficulty: 'medium',
    type: 'judge',
    question: 'JavaScript 的 V8 引擎使用分代垃圾回收策略，将堆内存分为新生代和老生代。',
    options: [
      { label: '正确', value: 'a' },
      { label: '错误', value: 'b' },
    ],
    answer: 'a',
    explanation: {
      correct: 'V8 使用分代回收：新生代使用 Scavenge 算法（频繁回收、空间小），老生代使用 Mark-Sweep + Mark-Compact（回收频率低、空间大）。',
      thinking: '分代回收基于"大多数对象生命周期很短"的假设。新创建的对象在新生代，存活足够久后晋升到老生代。',
      pitfalls: '新生代 Scavenge 算法将内存分为两半，每次只用一半，牺牲空间换时间。',
    },
  },
  {
    id: 218,
    ...
    difficulty: 'hard',
    type: 'single',
    question: 'Babel 将 ES6+ 代码转换为 ES5 的过程中，正确的步骤顺序是？',
    options: [
      { label: '代码生成 → 解析 → 转换', value: 'a' },
      { label: '解析 → 转换 → 代码生成', value: 'b' },
      { label: '转换 → 解析 → 代码生成', value: 'c' },
      { label: '解析 → 代码生成 → 转换', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'Babel 的三阶段流程：1) Parse（解析）—— 源代码 → AST；2) Transform（转换）—— 通过插件修改 AST；3) Generate（生成）—— AST → 目标代码。',
      thinking: '这是编译器的标准流程。Parse 阶段包括词法分析（Token 化）和语法分析（构建 AST）。Transform 阶段通过 Visitor 模式遍历和修改 AST 节点。',
      pitfalls: 'Babel 的插件系统工作在 Transform 阶段，通过操作 AST 来实现代码转换。',
    },
  },
  {
    id: 219,
    ...
    answer: 'c',
    explanation: {
      correct: '观察者模式是行为型设计模式，用于定义一对多的依赖关系。单例、工厂、建造者都是创建型模式。',
      thinking: '设计模式分三类：创建型（单例、工厂、建造者、原型）、结构型（适配器、代理、装饰器）、行为型（观察者、策略、命令、状态）。',
      pitfalls: '前端框架大量使用设计模式：Vue 响应式是观察者模式，React.createElement 是工厂模式，ES6 Proxy 是代理模式。',
    },
  },
  {
    id: 220,
    ...
    options: [
      { label: 'JavaScript 的 Bug', value: 'a' },
      { label: '浮点数精度丢失，0.1 和 0.2 的二进制表示是无限循环小数', value: 'b' },
      { label: '运算符优先级问题', value: 'c' },
      { label: '类型转换问题', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'JavaScript 使用 IEEE 754 双精度浮点数，0.1 和 0.2 的二进制表示是无限循环小数，存储时精度丢失，导致结果是 0.30000000000000004。',
      thinking: 'IEEE 754 用 64 位表示浮点数：1位符号 + 11位指数 + 52位尾数。0.1 的二进制是 0.000110011...（无限循环），52 位尾数无法精确存储。',
      pitfalls: '解决方案：Math.abs(0.1 + 0.2 - 0.3) < Number.EPSILON，或用整数运算：(0.1*10 + 0.2*10) / 10。',
    },
  },
  ...
  // ==================== 浏览器原理 ====================
  {
    ...
    difficulty: 'medium',
    type: 'single',
    question: '从输入 URL 到页面渲染，正确的顺序是？',
    options: [
      { label: 'DNS 解析 → HTTP 请求 → TCP 连接 → 渲染', value: 'a' },
      { label: 'DNS 解析 → TCP 连接 → HTTP 请求 → 渲染', value: 'b' },
      { label: 'TCP 连接 → DNS 解析 → HTTP 请求 → 渲染', value: 'c' },
      { label: 'HTTP 请求 → DNS 解析 → TCP 连接 → 渲染', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'DNS 解析（域名→IP）→ TCP 三次握手 → TLS 握手（HTTPS）→ HTTP 请求 → 服务器响应 → 浏览器解析渲染。',
      thinking: '完整流程：DNS → TCP → TLS → HTTP → 解析 HTML 构建 DOM → 解析 CSS 构建 CSSOM → 合并渲染树 → 布局 → 绘制 → 合成。',
      pitfalls: 'HTTPS 还需要 TLS 握手。HTTP/2 使用多路复用，HTTP/3 基于 UDP 的 QUIC 协议。',
    },
  },
  {
    id: 222,
    ...
    difficulty: 'hard',
    type: 'single',
    question: '以下哪个操作只触发 Composite（合成），不触发重排和重绘？',
    options: [
      { label: '修改 width', value: 'a' },
      { label: '修改 color', value: 'b' },
      { label: '修改 transform', value: 'c' },
      { label: '修改 margin', value: 'd' },
    ],
    answer: 'c',
    explanation: {
      correct: 'transform 和 opacity 的修改只触发合成层的操作，不涉及布局计算和重绘，性能最好。',
      thinking: '性能排序：Composite（最便宜）< Repaint < Reflow（最昂贵）。transform/opacity 只需合成器重新合成图层，GPU 加速处理。',
      pitfalls: 'will-change: transform 可以将元素提升为独立合成层，但不要滥用，会导致层爆炸。',
    },
  },
  {
    id: 223,
...
console.log('4');`,
    options: [
      { label: '1, 2, 3, 4', value: 'a' },
      { label: '1, 4, 3, 2', value: 'b' },
      { label: '1, 4, 2, 3', value: 'c' },
      { label: '1, 3, 4, 2', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '输出顺序：1 → 4 → 3 → 2。同步代码先执行，微任务（Promise）优先于宏任务（setTimeout）。',
      thinking: '事件循环的执行顺序：1) 执行同步代码（调用栈）；2) 执行所有微任务（Promise.then、MutationObserver）；3) 执行一个宏任务（setTimeout、setInterval）；4) 重复。',
      pitfalls: '即使 setTimeout 延迟为 0，它也是宏任务，必须等微任务队列清空后才执行。',
    },
  },
  {
    id: 224,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '<script async> 和 <script defer> 的区别是什么？',
    options: [
      { label: 'async 保持文档顺序，defer 不保持', value: 'a' },
      { label: 'defer 保持文档顺序，async 不保持', value: 'b' },
      { label: '两者完全相同', value: 'c' },
      { label: 'async 阻塞解析，defer 不阻塞', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'defer 保持文档顺序，在 DOM 解析完成后执行；async 不保证顺序，下载完立即执行。',
      thinking: '普通 script：阻塞解析，下载完立即执行。async：并行下载，下载完立即执行（可能阻塞）。defer：并行下载，DOMContentLoaded 前按顺序执行。',
      pitfalls: 'defer 脚本在 DOMContentLoaded 之前执行，async 脚本在下载完成后立即执行（可能在 DOM 解析完成前）。',
    },
  },
  {
    id: 225,
    ...
    difficulty: 'hard',
    type: 'single',
    question: 'V8 引擎中，新生代垃圾回收使用的算法是？',
    options: [
      { label: '标记-清除（Mark-Sweep）', value: 'a' },
      { label: '引用计数（Reference Counting）', value: 'b' },
      { label: 'Scavenge 算法', value: 'c' },
      { label: '标记-整理（Mark-Compact）', value: 'd' },
    ],
    answer: 'c',
    explanation: {
      correct: 'V8 新生代使用 Scavenge 算法，将内存分为两半（From 和 To），存活对象从 From 复制到 To，然后交换。',
      thinking: 'Scavenge 是 Cheney 算法的变体：空间换时间，适合新生代（对象生命周期短、存活率低）。老生代使用 Mark-Sweep + Mark-Compact。',
      pitfalls: 'Scavenge 牺牲一半空间，所以只用于小空间的新生代（1-8MB）。老生代空间大，用标记-清除和标记-整理。',
    },
  },
  ...
  // ==================== CSS ====================
  {
    ...
    difficulty: 'easy',
    type: 'single',
    question: 'CSS 盒模型中，box-sizing: border-box 的宽度包含哪些部分？',
    options: [
      { label: '只有 content', value: 'a' },
      { label: 'content + padding', value: 'b' },
      { label: 'content + padding + border', value: 'c' },
      { label: 'content + padding + border + margin', value: 'd' },
    ],
    answer: 'c',
    explanation: {
      correct: 'border-box 模式下，width 包含 content + padding + border。设置 width: 100px 就是实际占位 100px。',
      thinking: '标准盒模型（content-box）：width = content。IE 盒模型（border-box）：width = content + padding + border。现代开发推荐 border-box。',
      pitfalls: 'margin 永远不包含在 width 中，它是元素外部的间距。',
    },
  },
  {
    id: 227,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '以下哪个属性可以创建 BFC（块级格式化上下文）？',
    options: [
      { label: 'display: inline', value: 'a' },
      { label: 'overflow: hidden', value: 'b' },
      { label: 'float: none', value: 'c' },
      { label: 'position: static', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'overflow: hidden（非 visible）可以创建 BFC。其他方式：float、position: absolute/fixed、display: flex/grid/flow-root。',
      thinking: 'BFC 是一个独立的渲染区域，内部元素的布局不影响外部。BFC 可以解决：margin 重叠、清除浮动、防止文字环绕等。',
      pitfalls: 'display: inline 不能创建 BFC，display: inline-block 可以。position: static 是默认值，不能创建 BFC。',
    },
  },
  {
    id: 228,
    ...
    difficulty: 'medium',
    type: 'single',
    question: 'Flexbox 中，flex: 1 代表什么？',
    options: [
      { label: 'flex-grow: 1', value: 'a' },
      { label: 'flex-grow: 1; flex-shrink: 1; flex-basis: 0%', value: 'b' },
      { label: 'flex-grow: 1; flex-shrink: 0', value: 'c' },
      { label: 'width: 100%', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'flex: 1 是 flex-grow: 1; flex-shrink: 1; flex-basis: 0% 的简写，表示等分剩余空间。',
      thinking: 'flex 属性是 flex-grow、flex-shrink、flex-basis 的简写。flex: 1 = 1 1 0%，flex: auto = 1 1 auto，flex: none = 0 0 auto。',
      pitfalls: 'flex-basis: 0% 和 flex-basis: auto 的区别：0% 忽略内容大小等分空间，auto 以内容大小为基准。',
    },
  },
  {
    id: 229,
    ...
    difficulty: 'easy',
    type: 'single',
    question: 'CSS 中 position: fixed 的元素相对于什么定位？',
    options: [
      { label: '最近的定位祖先元素', value: 'a' },
      { label: '文档的初始包含块（视口）', value: 'b' },
      { label: 'body 元素', value: 'c' },
      { label: 'html 元素', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'position: fixed 相对于文档的初始包含块（通常是视口）定位，滚动时位置不变。',
      thinking: '五种定位：static（默认）、relative（相对自身）、absolute（最近定位祖先）、fixed（视口）、sticky（滚动时固定）。',
      pitfalls: '如果 fixed 元素的祖先有 transform、perspective 或 filter 属性，fixed 会相对于该祖先定位（不再是视口）。',
    },
  },
  {
    id: 230,
    ...
    difficulty: 'medium',
    type: 'single',
    question: 'CSS 选择器 .nav .item 和 .nav > .item 的区别是什么？',
    options: [
      { label: '没有区别', value: 'a' },
      { label: '前者选择所有后代，后者只选择直接子元素', value: 'b' },
      { label: '前者选择直接子元素，后者选择所有后代', value: 'c' },
      { label: '前者选择兄弟元素，后者选择子元素', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '.nav .item 是后代选择器，匹配 .nav 下所有 .item（包括嵌套多层）。.nav > .item 是子选择器，只匹配直接子元素。',
      thinking: '后代选择器（空格）匹配任意深度的后代。子选择器（>）只匹配直接子元素。相邻兄弟（+）匹配紧跟其后的兄弟。通用兄弟（~）匹配之后所有兄弟。',
      pitfalls: '子选择器更精确，性能也略好。在组件化开发中，建议用 > 限制选择器的作用范围。',
    },
  },
  ...
  // ==================== 计算机网络 ====================
  {
    ...
    options: [
      { label: 'HTTP/2 基于 UDP，HTTP/3 基于 TCP', value: 'a' },
      { label: 'HTTP/2 引入多路复用，HTTP/3 基于 QUIC（UDP）', value: 'b' },
      { label: 'HTTP/1.1 支持多路复用', value: 'c' },
      { label: '三者没有本质区别', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'HTTP/2 引入多路复用、头部压缩、服务器推送。HTTP/3 基于 QUIC 协议（UDP），解决 TCP 队头阻塞问题。',
      thinking: 'HTTP/1.1：文本协议、队头阻塞、Keep-Alive。HTTP/2：二进制分帧、多路复用、HPACK 压缩。HTTP/3：QUIC（UDP）、0-RTT 握手、独立流。',
      pitfalls: 'HTTP/2 的多路复用解决了 HTTP 层的队头阻塞，但 TCP 层仍有队头阻塞。HTTP/3 用 QUIC 彻底解决。',
    },
  },
  {
    id: 232,
    ...
    options: [
      { label: '加密数据传输', value: 'a' },
      { label: '确认双方的发送和接收能力都正常', value: 'b' },
      { label: '分配 IP 地址', value: 'c' },
      { label: '压缩数据包', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '三次握手的目的是确认客户端和服务端的发送、接收能力都正常，同步序列号和窗口大小。',
      thinking: '第一次：客户端 → 服务端（SYN，我准备好了）。第二次：服务端 → 客户端（SYN+ACK，我也准备好了）。第三次：客户端 → 服务端（ACK，确认收到）。',
      pitfalls: '为什么不是两次？两次无法确认服务端的接收能力和客户端的接收能力。为什么不是四次？三次已经足够。',
    },
  },
  {
    id: 233,
    ...
    difficulty: 'medium',
    type: 'single',
    question: 'HTTP 强缓存和协商缓存的区别是什么？',
    options: [
      { label: '强缓存需要发请求，协商缓存不需要', value: 'a' },
      { label: '强缓存不发请求直接用缓存，协商缓存发请求确认是否更新', value: 'b' },
      { label: '两者完全相同', value: 'c' },
      { label: '协商缓存的优先级更高', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '强缓存（Cache-Control/Expires）直接使用缓存，不发请求。协商缓存（ETag/Last-Modified）发请求确认资源是否更新。',
      thinking: '优先级：强缓存 > 协商缓存。强缓存命中返回 200（from cache）。协商缓存命中返回 304 Not Modified。',
      pitfalls: 'Cache-Control: max-age=3600 优先级高于 Expires。ETag 优先级高于 Last-Modified。',
    },
  },
  {
    id: 234,
    ...
    difficulty: 'medium',
    type: 'single',
    question: 'CORS 请求中，简单请求和预检请求的区别是什么？',
    options: [
      { label: '简单请求不需要 CORS', value: 'a' },
      { label: '简单请求直接发送，预检请求先发 OPTIONS 确认', value: 'b' },
      { label: '预检请求不需要服务器配置', value: 'c' },
      { label: '两者完全相同', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '简单请求（GET/POST/HEAD + 简单头部）直接发送。非简单请求会先发 OPTIONS 预检请求，确认服务器是否允许。',
      thinking: '简单请求条件：1) 方法是 GET/POST/HEAD；2) 只有简单头部（Accept、Content-Type 等）；3) Content-Type 是 text/plain、multipart/form-data 或 application/x-www-form-urlencoded。',
      pitfalls: 'application/json 的 POST 请求不是简单请求，会触发预检。带自定义头部（如 Authorization）也不是简单请求。',
    },
  },
  {
    id: 235,
    ...
    difficulty: 'easy',
    type: 'single',
    question: 'DNS 解析的作用是什么？',
    options: [
      { label: '加密网络请求', value: 'a' },
      { label: '将域名转换为 IP 地址', value: 'b' },
      { label: '压缩网页资源', value: 'c' },
      { label: '建立 TCP 连接', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'DNS（Domain Name System）将人类可读的域名（如 google.com）解析为计算机可识别的 IP 地址（如 142.250.80.46）。',
      thinking: 'DNS 解析过程：浏览器缓存 → 系统缓存 → 路由器缓存 → ISP DNS → 根域名服务器 → 顶级域名服务器 → 权威域名服务器。',
  ...
  // ==================== 小程序开发 ====================
  {
    ...
    difficulty: 'easy',
    type: 'single',
    question: '小程序中，用于描述页面结构的语言是？',
    options: [
      { label: 'HTML', value: 'a' },
      { label: 'WXML', value: 'b' },
      { label: 'JSX', value: 'c' },
      { label: 'Vue Template', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'WXML（WeiXin Markup Language）是微信小程序的页面描述语言，类似 HTML 但有自己的组件和语法。',
      thinking: '小程序三件套：WXML（结构）、WXSS（样式）、JS（逻辑）。WXML 使用 view、text、image 等小程序组件，支持数据绑定 wx:if、wx:for。',
      pitfalls: 'WXML 不是 HTML，不能使用 div、span 等 HTML 标签。WXSS 类似 CSS 但支持 rpx 响应式单位。',
    },
  },
  {
    id: 242,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '小程序的 setData 方法有什么作用？',
    options: [
      { label: '发送网络请求', value: 'a' },
      { label: '更新页面数据并触发视图重新渲染', value: 'b' },
      { label: '存储本地数据', value: 'c' },
      { label: '调用云函数', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: 'setData 是小程序更新页面数据的核心方法，它会将数据从逻辑层发送到视图层，触发视图重新渲染。',
      thinking: 'setData 的性能优化：1) 减少调用频率，批量更新；2) 只传变化的字段；3) 避免在滚动回调中频繁调用；4) 长列表考虑虚拟列表。',
      pitfalls: 'setData 是异步的，调用后数据不会立即更新。频繁调用 setData 会导致性能问题。',
    },
  },
  {
    id: 243,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '微信云开发中，以下哪个不是云开发提供的基础能力？',
    options: [
      { label: '云函数', value: 'a' },
      { label: '云数据库', value: 'b' },
      { label: '云存储', value: 'c' },
      { label: '云服务器（ECS）', value: 'd' },
    ],
    answer: 'd',
    explanation: {
      correct: '微信云开发提供云函数、云数据库、云存储三大基础能力，不需要传统的云服务器（ECS）。',
      thinking: '云开发是 Serverless 架构，开发者无需管理服务器。云函数处理业务逻辑，云数据库存储数据，云存储管理文件。',
      pitfalls: '云开发有免费额度，适合中小型项目。复杂业务或高并发场景可能需要自建服务器。',
    },
  },
  {
    id: 244,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '小程序的分包加载有什么好处？',
    options: [
      { label: '减少代码总量', value: 'a' },
      { label: '加快首屏加载速度，按需下载子包', value: 'b' },
      { label: '增加小程序功能', value: 'c' },
      { label: '提高代码安全性', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '分包加载将代码分成主包和子包，启动时只下载主包，进入子包页面时才下载对应子包，加快首屏加载速度。',
      thinking: '分包配置：主包包含启动页面和公共代码，子包包含其他页面。preloadRule 可以设置预加载规则，在空闲时预下载子包。',
      pitfalls: '单个分包不能超过 2MB，所有分包总和不能超过 20MB。主包尽量精简，把非首屏页面放到子包。',
    },
  },
  {
    id: 245,
    ...
    difficulty: 'hard',
    type: 'single',
    question: '小程序中如何实现防重复投票？',
    options: [
      { label: '使用 localStorage 记录', value: 'a' },
      { label: '在数据库中用 pollId + userId 建立唯一索引', value: 'b' },
      { label: '使用 Cookie 记录', value: 'c' },
      { label: '前端禁用投票按钮', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '在 vote_records 集合中用 pollId + userId 建立唯一索引，从数据库层面保证同一用户对同一投票只能投一次。',
      thinking: '防重复投票需要前后端配合：1) 前端根据已投票状态禁用按钮；2) 后端查询是否已投票；3) 数据库唯一索引兜底。三层防护缺一不可。',
      pitfalls: '仅靠前端禁用按钮是不安全的，用户可以绕过前端限制。必须在后端做校验。',
    },
  },
  ...
  // ==================== 设计模式 ====================
  {
    ...
    difficulty: 'easy',
    type: 'single',
    question: '以下哪个是单例模式的典型应用场景？',
    options: [
      { label: '创建多个按钮组件', value: 'a' },
      { label: '全局状态管理（如 Redux Store）', value: 'b' },
      { label: '表单验证', value: 'c' },
      { label: '事件监听', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '单例模式确保全局只有一个实例，Redux Store、Vuex Store、全局事件总线都是典型的单例应用。',
      thinking: '单例模式适用于：全局只需要一个实例的场景（状态管理、弹窗管理、日志器）。ES Module 的 import 天然是单例的。',
      pitfalls: '不是所有工具类都需要单例。过度使用单例会导致全局状态，测试困难。',
    },
  },
  {
    id: 247,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '观察者模式和发布-订阅模式的核心区别是什么？',
    options: [
      { label: '观察者模式更快', value: 'a' },
      { label: '观察者直接通知，发布订阅通过中间人解耦', value: 'b' },
      { label: '发布-订阅只支持字符串事件', value: 'c' },
      { label: '两者完全相同', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '观察者模式中 Subject 直接通知 Observer，两者直接耦合。发布-订阅通过 Event Channel 解耦，发布者和订阅者互不知道对方。',
      thinking: 'Vue 的响应式系统（Dep+Watcher）是观察者模式。EventBus、Node.js EventEmitter 是发布-订阅模式。',
      pitfalls: '实际开发中两者经常混用，面试时要能说清楚区别。',
    },
  },
  {
    id: 248,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '策略模式的核心思想是什么？',
    options: [
      { label: '把算法封装成类，使其可以互相替换', value: 'a' },
      { label: '让对象继承父类的方法', value: 'b' },
      { label: '缓存计算结果', value: 'c' },
      { label: '延迟对象的创建', value: 'd' },
    ],
    answer: 'a',
    explanation: {
      correct: '策略模式将不同的算法（策略）封装成独立的对象，使它们可以互相替换，避免了大量的 if-else 判断。',
      thinking: '策略模式的典型应用：表单验证（不同字段不同规则）、定价策略（不同会员不同折扣）、支付方式（微信/支付宝/银行卡）。',
      pitfalls: '策略模式和状态模式容易混淆。策略模式是客户端主动选择算法，状态模式是对象根据内部状态自动切换。',
    },
  },
  {
    id: 249,
    ...
    answer: 'b',
    explanation: {
      correct: 'ES6 Proxy 是代理模式的原生实现，通过拦截对象的操作（get/set/has/deleteProperty 等）来控制对象的访问。',
      thinking: 'Vue 3 用 Proxy 实现响应式数据劫持。其他代理应用：数据验证、缓存代理、图片懒加载、访问控制。',
      pitfalls: '代理模式控制访问，装饰器模式添加功能。两者都是包装对象，但目的不同。',
    },
  },
  {
    id: 250,
    ...
    difficulty: 'medium',
    type: 'single',
    question: 'React 的高阶组件（HOC）对应哪种设计模式？',
    options: [
      { label: '工厂模式', value: 'a' },
      { label: '代理模式', value: 'b' },
      { label: '装饰器模式', value: 'c' },
    ...
    answer: 'c',
    explanation: {
      correct: '高阶组件是装饰器模式的应用——不修改原组件，通过包装来增强功能（如添加认证、日志、错误边界等）。',
      thinking: 'HOC 接收一个组件，返回一个增强后的新组件。常见 HOC：withAuth、withLogger、withErrorBoundary。Vue 的 Mixins 和 Composables 也是装饰器思想。',
      pitfalls: 'HOC 会增加组件嵌套层级，React 推荐用 Hooks 替代。但 HOC 适合增强渲染逻辑，Hooks 适合复用状态逻辑。',
    },
  },
  ...
  // ==================== 公务员面试 ====================
  {
    ...
    difficulty: 'easy',
    type: 'single',
    question: '公务员结构化面试中，通常有多少名考官？',
    options: [
      { label: '3-4 名', value: 'a' },
      { label: '5-7 名', value: 'b' },
      { label: '8-10 名', value: 'c' },
      { label: '1 名', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '结构化面试通常由 5-7 名考官组成，设主考官 1 名，去掉最高分和最低分取平均值。',
      thinking: '考官数量设置的目的是保证评分的公正性。多个考官可以减少个人主观因素的影响，去掉最高最低分进一步保证公平。',
      pitfalls: '不同地区和岗位可能有差异，但 5-7 名是最常见的配置。',
    },
  },
  {
    id: 252,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '综合分析题中，分析社会现象时最常用的分析方法是？',
    options: [
      { label: '时间顺序法', value: 'a' },
      { label: '主体分析法（政府、社会、企业、个人）', value: 'b' },
      { label: 'SWOT 分析法', value: 'c' },
      { label: '5W1H 分析法', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '主体分析法是公务员面试综合分析题最常用的方法，从政府、社会、企业、个人等不同主体分析原因和对策。',
      thinking: '主体分析法的好处是条理清晰、覆盖全面。政府层面看政策和监管，社会层面看风气和舆论，企业层面看责任和自律，个人层面看意识和行为。',
      pitfalls: '分析时要根据具体题目选择相关主体，不是所有题目都要分析所有主体。',
    },
  },
  {
    id: 253,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '面对群众情绪激动的情况，首先应该做什么？',
    options: [
      { label: '立即解释政策', value: 'a' },
      { label: '安抚情绪，耐心倾听', value: 'b' },
      { label: '请领导出面处理', value: 'c' },
      { label: '让保安维持秩序', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '面对群众情绪激动，首先要安抚情绪、耐心倾听，让群众感受到被尊重和理解，然后再了解情况、解决问题。',
      thinking: '情绪激动时讲道理是无效的，必须先处理情绪再处理事情。安抚情绪的方法：请坐、倒水、表示理解、耐心倾听。',
      pitfalls: '不要在群众情绪激动时解释政策或讲道理，这只会火上浇油。',
    },
  },
  {
    id: 254,
    ...
    answer: 'd',
    explanation: {
      correct: '调研类题目的核心三要素是：调研对象（找谁调研）、调研方式（怎么调研）、调研内容（调研什么）。经费不是核心要素。',
      thinking: '调研对象要全面（相关部门、服务对象、专家学者等），调研方式要多样（问卷、走访、座谈等），调研内容要具体（现状、问题、原因、建议）。',
      pitfalls: '答题时不要花时间在经费预算上，考官更关注你的调研思路是否清晰。',
    },
  },
  {
    id: 255,
    ...
    difficulty: 'medium',
    type: 'single',
    question: '公务员面试中，回答人际关系题的首要原则是？',
    options: [
      { label: '指责对方的错误', value: 'a' },
      { label: '主动从自己身上找原因', value: 'b' },
      { label: '回避矛盾，保持沉默', value: 'c' },
      { label: '向领导打小报告', value: 'd' },
    ],
    answer: 'b',
    explanation: {
      correct: '人际关系题的首要原则是主动担责，先从自己身上找原因，而不是指责对方或推卸责任。',
      thinking: '这体现了公务员应有的谦逊态度和反思精神。即使对方有错，也要先反思自己是否有做得不够好的地方，然后再寻求沟通和解决。',
      pitfalls: '主动担责不等于无原则退让，涉及原则问题要坚持立场。',
    },
  },
];
